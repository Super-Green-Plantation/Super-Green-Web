      ...
      <div className="relative hidden lg:flex items-center justify-center bg-green-900">
        ...
        <div className="relative z-10 p-12 text-white max-w-lg">
          ...
          <p className="text-lg text-green-50 mb-8 font-light leading-relaxed">
            Log in to access your dashboard, manage your supply chain, and stay updated with our latest harvests.
          </p>
          ...
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100">
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-gray-500 text-sm mt-2">
                New to the platform? 
                <Link href="/auth/register" className="text-green-600 font-semibold hover:underline ml-1">Create an account</Link>
              </p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="remember" className="w-4 h-4 accent-green-600 rounded" />
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-gray-400 font-medium tracking-tighter">Secure Login</span></div>
            </div>
